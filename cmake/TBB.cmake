...
set(INSTALL_COMMAND
    COMMAND cp -r ${COMPONENT_PATH}/src/${TBB_ROOT_DIR}/include ${CMAKE_INSTALL_PREFIX}
    COMMAND cp -r ${COMPONENT_PATH}/src/${TBB_ROOT_DIR}/bin ${CMAKE_INSTALL_PREFIX}
    COMMAND cp -r ${COMPONENT_PATH}/src/${TBB_ROOT_DIR}/lib ${CMAKE_INSTALL_PREFIX}
)
